...
st.markdown(
    ...
    .match-pill {{
        float: right; background: {NAVY}; color: #ffffff !important; font-weight: 700;
    ...
    /* Resume Analyzer paste box — hardcoded dark navy + white text, same in every mode */
    textarea[placeholder="Paste your resume content..."] {{
        background-color: {NAVY} !important;
        color: #ffffff !important;
        caret-color: #ffffff !important;
        border: 1px solid {GOLD} !important;
    }}
    textarea[placeholder="Paste your resume content..."]::placeholder {{
